...
class DataValidationConfig:
    def __init__(self,traininf_pipeline_config:TrainingPipelineConfig):
        self.data_validation_dir:str = os.path.join(traininf_pipeline_config.artifact_dir , training_pipeline.DATA_VALIDATION_DIR_NAME)
        
        self.valid_data_dir:str = os.path.join(traininf_pipeline_config.artifact_dir , training_pipeline.DATA_VALIDATION_VALID_DIR)
        
        self.invalid_data_dir:str = os.path.join(traininf_pipeline_config.artifact_dir , training_pipeline.DATA_VALIDATION_INVALID_DIR)
